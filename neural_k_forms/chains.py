...
def generate_cochain_data_matrix(form, chain, d=5):
    """Generate a cochain data matrix from a chain and a 1-form.

    This is the main entry point for generating a cochain data matrix.
    All chains are integrated according to the 1-form.
    ...
    torch.tensor of shape (r,c)
        The cochain data matrix, with `r` representing the number of
